...
export default function RulesModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="bg-black/90 text-white rounded-xl w-full max-w-sm sm:max-w-md md:max-w-lg">
        <DialogHeader>
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            >
              <SelectTrigger className="w-[130px] bg-black border border-yellow-400 text-yellow-400 hover:border-yellow-500 text-sm">
        ...
        <p className="text-sm text-gray-300 mt-2">{langContent.description}</p>
